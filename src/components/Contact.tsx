...
export const Contact: React.FC = () => {
  ...
  const linkedinIconSvg = (
    <svg className="h-5 w-5 text-violet-400 group-hover:text-violet-350" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-6 w-full">
            ...
            <div className="rounded-xl bg-slate-900/10 border border-slate-900 p-5">
              <h4 className="text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1">Location Details</h4>
              <p className="text-xs text-slate-400 leading-relaxed">
                Based in Mannheim, Baden-Württemberg, Germany. Working-student arrangements are feasible locally or hybrid/remote across Germany.
              </p>
            </div>
          </div>
