      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex-shrink-0">
            <a
              href="#"
              className="font-sans font-extrabold text-xl tracking-tight bg-gradient-to-r from-violet-400 to-fuchsia-400 bg-clip-text text-transparent"
            >
              {name.split(" ")[0]}
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            {linkedin ? (
              ...
              <span
                className="text-slate-500 cursor-not-allowed opacity-40"
